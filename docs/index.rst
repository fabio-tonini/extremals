...
~~~~~~~~~~~~
    ...
    Once one obtains a series of dataframe as result of one or more tests, the function :py:func:`OutOfBound <extremals.OutOfBound>` can be used to extrapolate extremal
